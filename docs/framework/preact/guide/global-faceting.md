---
title: Global Faceting (Preact) Guide
---
...
```tsx
import { useTable, tableFeatures, columnFacetingFeature, createFacetedRowModel, createFacetedUniqueValues, createFacetedMinMaxValues } from '@tanstack/preact-table'
