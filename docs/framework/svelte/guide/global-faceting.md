---
title: Global Faceting (Svelte) Guide
---
...
```ts
import { createTable, tableFeatures, columnFacetingFeature, createFacetedRowModel, createFacetedUniqueValues, createFacetedMinMaxValues } from '@tanstack/svelte-table'
