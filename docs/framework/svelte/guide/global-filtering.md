...
const [globalFilter, setGlobalFilter] = createTableState<any>('')
...
```ts
const [globalFilter, setGlobalFilter] = createTableState('search term') // recommended to initialize globalFilter state here
